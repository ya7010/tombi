pub fn try_from_offset_date_time(
    ...
    chrono::DateTime::parse_from_rfc3339(&make_datetime_str(value))
}

pub fn try_from_local_date_time(value: &str) -> Result<chrono::NaiveDateTime, chrono::ParseError> {
    chrono::NaiveDateTime::parse_from_str(&make_datetime_str(value), "%Y-%m-%d %H:%M:%S%.f")
}
...
#[inline]
fn make_datetime_str(value: &str) -> String {
