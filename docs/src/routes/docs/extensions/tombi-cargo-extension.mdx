...
In this case, when your cursor is on `workspace`, executing "Go to Definition" will navigate you to the workspace definition or to the definition of the crate managed by the workspace.
...
<Note>
If you consistently want to navigate to the Cargo.toml where the workspace is defined, execute "Go to Declaration".
</Note>
