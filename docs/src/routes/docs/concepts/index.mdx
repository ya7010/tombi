...
The rules are determined by the service provider, not your team.  
Just like new programming languages come with formatters from the beginning, the service provider determines the rules.
